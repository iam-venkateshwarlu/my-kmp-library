...
@NonNullApi
public class CryptoAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CryptoAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
